...
def execute_planner_path(
    *,
    ...
    gather_email = "email" in request_plan.needed_context_sources or bool(request_plan.planning_metadata.get("mentions_inbox"))
    gather_calendar = "calendar" in request_plan.needed_context_sources or request_plan.time_horizon in {"today", "tomorrow", "this_week", "next_week", "week_after_next"}
    gather_documents = "documents" in request_plan.needed_context_sources or bool(document_context)
...
def run_planner_stage(
    *,
    ...
    if stage_key == "gather_email":
        ...
        status = "completed" if document_context or "documents" in request_plan.needed_context_sources else "skipped"
