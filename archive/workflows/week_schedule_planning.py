...
WEEK_SCHEDULE_PLANNING_WORKFLOW = WorkflowDefinition(
    workflow_type="week_schedule_planning",
    ...
    metadata={
        ...
        "presentation_variant": "week_timeline",
        "context_stages": json.dumps(EVENT_BRIEFING_CONTEXT_STAGES),
        "execution_model": "carrier_workflow_with_planner_execution",
        "failure_title": "Week Schedule Planning Failed",
        "failure_summary": "The system could not build a weekly schedule from your current email and calendar context.",
    },
)
