...
DAY_SCHEDULE_PLANNING_WORKFLOW = WorkflowDefinition(
    ...
    metadata={
        ...
        "failure_title": "Day Schedule Planning Failed",
        "failure_summary": "The system could not build a schedule proposal from your current email and calendar context.",
    },
)
